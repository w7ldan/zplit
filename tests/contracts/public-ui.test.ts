...
describe("Public UI contract", () => {
  ...
  it("keeps authenticated selectors out of public styles", () => {
    ...
    expect(motionSource).toContain('window.requestAnimationFrame(update)');
  });
});
