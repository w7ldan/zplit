...
describe("backup integrity", () => {
  ...
  it("keeps all expected tables and integrity SQL checks explicit", () => {
    expect(EXPECTED_TABLES).toEqual(expect.arrayContaining([
      "users", "account_invitations", "ledger_scopes", "debtor_share_links", "friends", "expenses", "expense_receipts", "repayments", "repayment_destinations", "repayment_proofs", "repayment_allocations", "groups", "group_participants", "group_memberships", "group_expenses", "group_expense_shares", "group_obligations", "group_expense_receipts",
    ]));
