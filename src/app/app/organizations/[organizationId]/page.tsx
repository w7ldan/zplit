...
export default async function OrganizationDetailPage({
  ...
  const summary = organization.canViewLedger
    ? (
        await getAuthenticatedOrganizationLedger(organizationId, "ledger.view", session)
      ).ledger.getLedgerOverviewSummary()
    : null;
      ...
      <div className="editorial-shell app-page__layout">
        ...
        {organization.canViewLedger && ledgerSummary ? (
          <section
            ...
            aria-labelledby="organization-ledger-heading"
          >
            <div>
              <p className="technical-label">OVERVIEW</p>
              <h2 id="organization-ledger-heading">Shared ledger at a glance</h2>
              <p className="organization-detail__supporting-copy">
                Use this workspace to track shared spending, repayment, and the people connected to it.
              </p>
            </div>
          ...
          <section className="organization-detail__section organization-detail__overview">
            <p className="organization-detail__supporting-copy">
              This Organization workspace is ready for the capabilities available to you.
            </p>
          </section>
        )}
      </div>
