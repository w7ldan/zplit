...
export default async function OrganizationTripsPage({
  params,
    ...
    <section className="app-page trips-page" id="top">
      <div className="editorial-shell app-page__layout">
        <div className="app-page__header">
          <div>
            <p className="technical-label">Organization trips · grouped outings</p>
            <h1>Trips</h1>
            <p className="app-page__lede">
              Group related outings without changing ledger calculations.
            </p>
          </div>
          {canManage ? (
            <Link
        ...
        <div className="records-workspace">
          <div className="records-workspace__toolbar">
            <LiveRecordFilters
              ...
              clearHref={
                filters.q ? recordHref(path, query, { q: undefined, page: undefined }) : undefined
              }
              resultStatus={`${page.totalItems} trip${page.totalItems === 1 ? "" : "s"} found.`}
          ...
          <div className="ledger-list" id="record-list">
            ...
            {page.items.length ? (
              ...
              <div className="ledger-empty">
                <h2>{filters.q ? "No matching Trips." : "No Trips yet."}</h2>
                <p>Group related outings before adding ledger records.</p>
              </div>
            )}
            <RecordPagination
              page={page.page}
      ...
      {canManage && first(query.create) === "1" ? (
        ...
        >
          <TripForm action={createTripAction.bind(null, organizationId)} />
        </TaskPanel>
      ) : null}
    </section>
  );
