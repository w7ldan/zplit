    ...
    <section className="app-page group-detail-page" id="top">
      <div className="editorial-shell app-page__layout">
        <section className="group-detail__section group-detail__overview">
          ...
          <p className="group-detail__supporting-copy">Record shared spending here. Confirmed expenses create clear participant-to-participant obligations.</p>
          <div className="group-detail__facts">
            <span>
              <strong>{group.participantCount}</strong> participants
            </span>
            <span>
              <strong>{group.memberCount}</strong> registered members
            </span>
            <span>
              <strong>{group.externalParticipantCount}</strong> external participants
            </span>
          </div>
        </section>
        <section
          className="group-detail__section"
          aria-labelledby="group-people-heading"
        >
