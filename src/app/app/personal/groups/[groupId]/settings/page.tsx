...
export default async function GroupSettingsPage({ params, searchParams = Promise.resolve({}) }: { params: Promise<{ groupId: string }>; searchParams?: Promise<{ error?: string | string[] }> }) {
