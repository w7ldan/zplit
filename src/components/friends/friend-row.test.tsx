...
describe("FriendRow", () => {
  it("exposes stable friend, state, created, outstanding, and action fields", () => {
    render(<FriendRow friend={{ id: "friend-a", ownerUserId: "owner-a", name: "Rani", phoneNumber: "+62 812", notes: null, archivedAt: null, createdAt: new Date("2026-01-01T00:00:00Z"), updatedAt: new Date("2026-01-01T00:00:00Z") }} balance={{ assignedAmount: 84_000, repaidAmount: 20_000, outstandingAmount: 64_000 }} />);
