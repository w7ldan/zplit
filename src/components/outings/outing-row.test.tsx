...
describe("OutingRow", () => {
  it("keeps the outing metadata and grouped actions available", () => {
    render(<OutingRow outing={{ id: "outing-a", title: "Dinner", occurredAt: new Date("2026-01-01T00:00:00Z"), occurredOn: null }} expenseCount={2} expenseTotal={84_000} />);
  ...
  it("links a grouped Trip and leaves the dense ledger unlinked value compact", () => {
    render(<OutingRow outing={{ id: "outing-a", title: "Dinner", occurredAt: new Date("2026-01-01T00:00:00Z"), occurredOn: null, tripId: "trip-a", tripName: "Bandung" }} expenseCount={2} expenseTotal={84_000} />);
  ...
  it("keeps an unbroken outing name in the rendered row", () => {
    ...
    render(<OutingRow outing={{ id: "outing-a", title, occurredAt: new Date("2026-01-01T00:00:00Z"), occurredOn: null }} expenseCount={1} expenseTotal={84_000} />);
