...
describe("OutingRow", () => {
  ...
  it("links a grouped Trip and leaves the dense ledger unlinked value compact", () => {
    render(<OutingRow outing={{ id: "outing-a", ownerUserId: "owner-a", title: "Dinner", occurredAt: new Date("2026-01-01T00:00:00Z"), notes: null, tripId: "trip-a", tripName: "Bandung", createdAt: new Date("2026-01-01T00:00:00Z"), updatedAt: new Date("2026-01-01T00:00:00Z") }} expenseCount={2} expenseTotal={84_000} />);
